...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            locationManager.requestLocationUpdates(providerName, 500, 1, new GPSLocationListener());
    ...
    public void getLongAndLat() {
        try {
            ...
            Toast.makeText(MainActivity.this, "Don't have permission to access GPS", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void displayInfo()
    {
        ...
        longandLat.setText("Latitude: " + latitude + "\n Longitude: " + longitude);
    ...
    public class GeoPluginNearestCity extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute(){
            showProgress = ProgressDialog.show(MainActivity.this,"Progress","Looking For a Location Information",true);
        }
